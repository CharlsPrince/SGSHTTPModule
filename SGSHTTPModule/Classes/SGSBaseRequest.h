...
FOUNDATION_EXPORT NSString * SGSRequestMethodString(SGSRequestMethod method);
 ...
 *  @abstract 请求报头自定义参数
 *
 *  @discussion 如果缓存策略为 NSURLRequestReloadIgnoringLocalCacheData，
 *      并且该属性的 If-Modified-Since 或 If-None-Match 为空时会自动从 NSURLCache 中读取值并添加到请求头中
 *
 *  @return 请求报头参数字典
 */
