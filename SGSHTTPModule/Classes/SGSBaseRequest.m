...
NSString * SGSRequestMethodString(SGSRequestMethod method) {
    switch (method) {
        case SGSRequestMethodGet:    return @"GET";
        case SGSRequestMethodPost:   return @"POST";
        case SGSRequestMethodHead:   return @"HEAD";
        case SGSRequestMethodPut:    return @"PUT";
        case SGSRequestMethodPatch:  return @"PATCH";
        case SGSRequestMethodDelete: return @"DELETE";
        default: return @"GET";
    }
}
