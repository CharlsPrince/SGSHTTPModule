/*!
 *  @file AFURLSessionManager+SGS.m
 *
...
{
    NSString *httpMethod = SGSRequestMethodString(request.requestMethod);
    ...
    if (error != nil) {
        ...
        if ([mutRequest valueForHTTPHeaderField:@"If-None-Match"] == nil) {
            [mutRequest setValue:cachedHeaders[@"Etag"] forHTTPHeaderField:@"If-None-Match"];
        }
    }
